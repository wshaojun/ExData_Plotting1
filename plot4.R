...
plot(rawdata$date_time,rawdata$Global_active_power, type = "l", xlab = "", ylab = "Global Active Power")

plot(rawdata$date_time,rawdata$Voltage, type = "l", xlab = "datetime", ylab = "Voltage")
...
plot(rawdata$date_time,rawdata$Global_reactive_power, type = "l", xlab = "datetime", ylab = "Global_reactive_power")
